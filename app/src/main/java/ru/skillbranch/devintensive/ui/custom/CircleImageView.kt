...
class CircleImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        if (a.hasValue(R.styleable.CircleImageView_cv_circleBackgroundColor)) {
            mCircleBackgroundColor = a.getColor(
                R.styleable.CircleImageView_cv_circleBackgroundColor,
                DEFAULT_CIRCLE_BACKGROUND_COLOR
            )
        } else if (a.hasValue(R.styleable.CircleImageView_cv_fillColor)) {
            mCircleBackgroundColor = a.getColor(
                R.styleable.CircleImageView_cv_fillColor,
                DEFAULT_CIRCLE_BACKGROUND_COLOR
            )
        }
    ...
    @Dimension
    fun getBorderWidth(): Int = mBorderWidth.toDp()

    fun getBorderColor(): Int = mBorderColor


    fun setBorderWidth(@Dimension dp: Int) {
        if (dp.toPx() == mBorderWidth) {
            return
        }
        mBorderWidth = dp.toPx()
        setup()
